...
import com.arno.lyramp.feature.listening_history.domain.mapper.YandexTracksMapper
...
internal class YandexMusicService(
        ...
        override suspend fun getListeningHistory(limit: Int?): List<ListeningHistoryMusicTrack> = runCatching {
                val token = authToken(MusicServiceType.YANDEX)
                        ?: error("YandexMusicService: No valid access token available!")
